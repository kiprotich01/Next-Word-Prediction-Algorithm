...
<ul>
    <li><a target="_blank" href="https://bswift.shinyapps.io/prediction-algorithm/">https://bswift.shinyapps.io/prediction-algorithm/</a></li>
</ul>

The source code files can be found on GitHub:

<ul>
    <li><a target="_blank" href="https://github.com/oraclejavanet/coursera-data-science-capstone/">https://github.com/kiprotich01/Prediction-Algorithm.git</a></li>
</ul>
...
<a target="_blank" href="http://www.idevelopment.info/data/DataScience/uploads/next-word-predict-ui-large.png"><img src="images/prediction_algorithm_ui.png"></a>
